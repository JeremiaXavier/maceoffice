...
<table id="tb1" border=1 style="width: 100%;border-collapse: collapse;">
    ...
    <tr>
        ...
        <td class="small-size"><?= date('d/m/Y', strtotime($reportsDetails->date_of_vacancy)) ?></td>
    </tr>
    <tr>
        <td style="width:6%;text-align:right;"> b)</td>
    ...
    <tr>
        ...
        <?php else : ?>
            <td class="small-size"><?= $reportsDetails->director_order_no . ' ' . date('d/m/Y', strtotime($reportsDetails->director_order_date)) ?></td>
        <?php endif; ?>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="small-size">
            <?= $reportsDetails->employee_housename ?>, <br>
            <?= $reportsDetails->employee_postoffice ?>, <br>
            <?= $reportsDetails->employee_city ?>, <br>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <?php
        $key = array_search($reportsDetails->university_order_attached, array_column($have_and_not_enum, 'id'));
        $university_order_attached = $have_and_not_enum[$key]['value'];
        ?>
        <td class="small-size">
            <?= $university_order_attached  ?>
        </td>
    </tr>
    <tr>
