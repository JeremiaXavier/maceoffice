                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row" id="teachers-div">
                                <?php
                                $report_time = date('F', mktime(0, 0, 0, $reportsDetails->report_month, 10));
                                //$report_time = $reportsDetails->report_month;
                                ?>
                    ...
                    <div class="row teachers-div">
                        ...
                        foreach ($teacherDetails as $teachers) : ?>
                            <div class="row">
                                ...
                                <div class="input-group mb-10">
                                    <span class="input-group-text"><?= $i++ ?></span>
                                    <input type="hidden" value="<?= en_func($teachers->teacher_id,'e') ?>" id="teachers" name="teachers[]" class="form-control">
                                    <input type="hidden" value="<?= en_func($teachers->rt_id,'e') ?>" id="rt_id" name="rt_id[]" class="form-control">

                                    <input type="text" value="<?= $teachers->teacher_name . ' - ' . $teachers->teacher_code ?>" id="teacher_name" name="teacher_name[]" class="form-control" readonly>
                                    <input type="text" id="days" value="<?= $teachers->days ?>" name="days[]" class="form-control">
                                    <input type="text" id="income_tax" value="<?= $teachers->income_tax ?>" value="0" name="income_tax[]" class="form-control">

                                    <span class="input-group-text btn-warning remove_teacher"> <i class="fa fa-trash"></i></span>
...
<script>
    ...
    $(document).on('change', '.form-check-input', function() {
        ...
        toastSuccess(toast_status, teacher_name, false);
        show_teachers();
