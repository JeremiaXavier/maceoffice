  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Letters Senders List</h2>
              <p>List of Letters Senders uploaded in this portal.</p>
          </div>
      </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/letters/senders_json" class="datatable-list row">
                      ...
                      <div class="col-6 col-md-3">
                          <a class="btn btn-primary float-end open-offcanvas" data-url="<?= base_url() ?>admin/letters/add_senders">Add sender</a>
                      </div>
