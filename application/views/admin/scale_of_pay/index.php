  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Scale of pay List</h2>
              <p>List of scale of pay uploaded in this portal.</p>
          </div>
      </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              ...
              <form action="<?= base_url() ?>admin/scale_of_pay/scale_of_pay_json" class="datatable-list row">
                  ...
                  <div class="col-6 col-md-3">
                      <a class="btn btn-primary float-end open-offcanvas" data-url="<?= base_url() ?>admin/scale_of_pay/add_scale_of_pay">Add scale of pay</a>
                    </div>
