  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Permanent Employees List</h2>
              <p>List of permanent employee details uploaded in this portal.</p>
          </div>
      </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              ...
              <form action="<?= base_url() ?>admin/permanent_employees/permanent_employees_json" class="datatable-list row">
                  ...
                  <div class="col-6 col-md-3">
                      <a class="btn btn-primary float-end open-offcanvas" data-url="<?= base_url() ?>admin/permanent_employees/add_permanent_employees">Add permanent employee</a>
                    </div>
