<section class="content-main">
    <?php if ($operation == 'add') : ?>
        <?php echo form_open(base_url('admin/employees/save_probation_details'), 'class="form-horizontal" id="add-form" enctype="multipart/form-data"') ?>
    <?php endif;
    if ($operation == 'edit') :  ?>
        <?php echo form_open(base_url('admin/employees/update_probation_details'), 'class="form-horizontal" id="add-form" enctype="multipart/form-data"') ?>
    ...
    <div class="content-header">
        <div>
            <h2 class="content-title card-title"><a href="<?= base_url() ?>admin/employees/index/<?= $employee_id ?>">Employee Details</a> / Probation Details</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-body">
                    <a href="<?= base_url() ?>admin/employees/qualification_details/<?= $employee_id ?>" class="float-start">
                        <h5 class="text-white"><i class="fa fa-arrow-left mr-10"></i> Qualifications details </h5>
                    </a>
                </div>
            </div>
        </div>
