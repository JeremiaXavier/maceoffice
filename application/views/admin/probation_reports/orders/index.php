  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Probation Orders List</h2>
              <p>List of probation orders uploaded in this portal.</p>
          </div>
      </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/probation_reports/orders_json" class="datatable-list row">
                      ...
                      <div class="col-6 col-md-3">
                          <a class="btn btn-primary float-end open-offcanvas" data-url="<?= base_url() ?>admin/probation_reports/add_orders">Add order</a>
                      </div>
