<section class="content-main">
    ...
    <div class="content-header">
        <div>
            <h2 class="content-title card-title"><a href="<?= base_url() ?>users/employees">Employee Details</a> / Qualification Details</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-body">
                    <a href="<?= base_url() ?>users/employees/appoinment_details" class="float-start">
                        <h5 class="text-white"><i class="fa fa-arrow-left mr-10"></i> Appoinment details </h5>
                    </a>
                    <a href="<?= base_url() ?>users/employees/probation_details" class="float-end">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header row">
                    ...
                    <div class="col-3">
                        <a data-url="<?= base_url() ?>users/employees/add_qualification_details" class="btn btn-info btn-sm open-offcanvas">Add <i class="fa fa-plus-circle ml-5"></i> </a>
                    </div>
                </div>
                            ...
                            <div class="card card-product-grid">
                                ...
                                <div class="info-wrap">
                                    ...
                                    <div class="action-buttons mt-15">
                                        <a data-url="<?= base_url() ?>users/employees/edit_qualification_details/<?= en_func($educationDetail->eq_id, 'e') ?>" class="btn btn-sm font-sm rounded btn-brand open-offcanvas"> <i class="material-icons md-edit"></i> Edit </a>
