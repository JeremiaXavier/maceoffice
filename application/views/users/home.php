<section class="content-main">
  ...
  <div class="alert alert-warning" role="alert">
    If you have not changed the Password, <br><br> 
    Then you can reset the password by clicking here - <a class="btn-primary bold-underline" href="<?= base_url() ?>users/profile"> Reset Password </a> <br>
    <br><b class="bold-underline">Kindly ignore this if you have changed the password</b>
  </div>

  <div class="alert alert-warning" role="alert">
    Employee Details Form is OPEN now , Please fill it if not done. <br> <br>
    Click on "<a href="<?= base_url() ?>users/employees" class="btn-primary bold-underline">Employee Details</a>" on the left menu and start filling
  </div>
