    ...
    <header class="main-header style-2 navbar">
      <div class="col-brand">
        <a href="<?= base_url() ?>" class="brand-wrap">
          ...
          <h1><span class="text-primary">MACE</span> Office - Administrator</h1>
    ...
    <section class="content-main mt-20 ">
      <div class="card mx-auto card-login">
        <div class="card-body">
          ...
          <h4 class="card-title mb-4">Sign in as an <a href="#">Administrator</a></h4>
          <?php echo form_open(base_url('admin/save_login'), 'class="row g-3 needs-validation" id="login-forms" autocomplete="off" '); ?>
